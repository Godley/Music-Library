...
\caption{Three separate parts in one score}
\label{fig:parts}	
\end{figure}
...
Table \ref{table:software} shows the alternative options for viewing music software.
\begin{table}[H]
