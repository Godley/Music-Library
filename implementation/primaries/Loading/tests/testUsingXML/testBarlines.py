...
from implementation.primaries.Loading.classes import Measure
import os
...
class testBarlines(xmlSet):
    ...
    def testMeasure2Barline(self):
        item = piece.Parts[self.p_id].measures[2]
    ...
    def testMeasure4Barline(self):
        item = piece.Parts[self.p_id].measures[4]
        self.assertTrue(hasattr(item, "barlines"))
    ...
    def testMeasure5Barline(self):
        item = piece.Parts[self.p_id].measures[5]
        self.assertTrue(hasattr(item, "barlines"))
    ...
    def testMeasure6BarlineRight(self):
        item = piece.Parts[self.p_id].measures[6]
        self.assertTrue(hasattr(item, "barlines"))
    ...
    def testMeasure7BarlineLeft(self):
        item = piece.Parts[self.p_id].measures[7]
        self.assertTrue(hasattr(item, "barlines"))
    ...
    def testMeasure8BarlineLeft(self):
        item = piece.Parts[self.p_id].measures[8]
        self.assertTrue(hasattr(item, "barlines"))
    ...
    def testMeasure9Barline(self):
        item = piece.Parts[self.p_id].measures[9]
        self.assertTrue(hasattr(item, "barlines"))
