...
class testHandleDirections(unittest.TestCase):
    ...
    def testWordsWithFontSizeAttrib(self):
        ...
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.assertTrue(hasattr(self.measure.directions[0], "size"))
    ...
    def testWordsWithFontFamAttrib(self):
        ...
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.assertTrue(hasattr(self.measure.directions[0], "font"))
...
class testMetronome(testHandleDirections):
    ...
    def testMetronomeBeatUnitTag(self):
        ...
        self.handler(self.tags,self.attrs,self.chars, self.piece)
        self.assertTrue(hasattr(self.measure.directions[0], "beat"))
        self.assertEqual("quarter",self.measure.directions[0].beat)
    ...
    def testBeatUnitWithFontAttrib(self):
        ...
        self.assertTrue(hasattr(self.measure.directions[0], "beat"))
        self.assertEqual("quarter",self.measure.directions[0].beat)
        self.assertTrue(hasattr(self.measure.directions[0],"parentheses"))
        self.assertEqual(True, self.measure.directions[0].parentheses)
    ...
    def testPerMinuteTag(self):
        ...
        self.handler(self.tags,self.attrs,self.chars,self.piece)
        self.assertEqual(1, len(self.measure.directions))
        self.assertTrue(hasattr(self.measure.directions[0], "min"))
        self.assertEqual("85",self.measure.directions[0].min)
    ...
    def testPerMinuteParenthesesAttrib(self):
        ...
        self.handler(self.tags,self.attrs,self.chars,self.piece)
        self.assertTrue(hasattr(self.measure.directions[0],"parentheses"))
        self.assertTrue(self.measure.directions[0].parentheses)

    def testPerMinuteAllAttribs(self):
        self.tags.append("per-minute")
        self.chars["per-minute"] = "85"
        self.attrs["metronome"] = {"parentheses":"yes","font-size":"6.5","font-family":"times"}
        self.handler(self.tags,self.attrs,self.chars,self.piece)
        self.assertTrue(hasattr(self.measure.directions[0],"parentheses"))
        self.assertTrue(self.measure.directions[0].parentheses)
        self.assertTrue(hasattr(self.measure.directions[0],"size"))
...
class testDynamicsAndSound(testHandleDirections):
    def testDynamicTag(self):
        ...
        self.tags.append("p")
        self.handler(self.tags,self.attrs,self.chars,self.piece)
        self.assertTrue(len(self.measure.directions) > 0)
        self.assertEqual(text.Dynamic,type(self.measure.directions[-1]))
        self.assertEqual("p",self.measure.directions[-1].mark)
