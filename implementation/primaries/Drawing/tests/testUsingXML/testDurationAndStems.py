...
class testStems(xmlSet):
    ...
    def testMeasure1(self):
        note = piece.Parts[self.p_id].measures[1].notes[1][0]
        self.assertFalse(hasattr(note, "stem"))

    def testMeasure2Note1(self):
        note = piece.Parts[self.p_id].measures[2].notes[1][0]
    ...
    def testMeasure2Note2(self):
        note = piece.Parts[self.p_id].measures[2].notes[1][1]
        self.assertTrue(hasattr(note, "stem"))
    ...
    def testMeasure2Note3(self):
        note = piece.Parts[self.p_id].measures[2].notes[1][2]
        self.assertTrue(hasattr(note, "stem"))
    ...
    def testMeasure3Note1(self):
        note = piece.Parts[self.p_id].measures[3].notes[1][0]
        self.assertTrue(hasattr(note, "stem"))
    ...
    def testMeasure3Note2(self):
        note = piece.Parts[self.p_id].measures[3].notes[1][1]
        self.assertTrue(hasattr(note, "stem"))
    ...
    def testMeasure3Note3(self):
        note = piece.Parts[self.p_id].measures[3].notes[1][2]
        self.assertTrue(hasattr(note, "stem"))
    ...
    def testMeasure3Note4(self):
        note = piece.Parts[self.p_id].measures[3].notes[1][3]
        self.assertTrue(hasattr(note, "stem"))
