...
class testDynamics(xmlSet):
    ...
    def testMeasure1Direction1(self):
        ...
        self.assertIsInstance(measure.expressions[1][0][0], Directions.Dynamic)

    def testMeasure1Direction1Val(self):
        measure = piece.Parts[self.p_id].measures[1]
        self.assertEqual("ppp", measure.expressions[1][0][0].mark)

    def testMeasure1Direction3(self):
        measure = piece.Parts[self.p_id].measures[1]
        self.assertIsInstance(measure.expressions[1][0][1], Directions.Dynamic)

    def testMeasure1Direction3Val(self):
        measure = piece.Parts[self.p_id].measures[1]
        self.assertEqual("pp", measure.expressions[1][0][1].mark)

    def testMeasure1Direction5(self):
        measure = piece.Parts[self.p_id].measures[1]
        self.assertIsInstance(measure.expressions[1][1][0], Directions.Dynamic)

    def testMeasure1Direction5Val(self):
        measure = piece.Parts[self.p_id].measures[1]
        self.assertEqual("p", measure.expressions[1][1][0].mark)

    def testMeasure1Direction7(self):
        measure = piece.Parts[self.p_id].measures[1]
        self.assertIsInstance(measure.expressions[1][2][0], Directions.Dynamic)

    def testMeasure1Direction7Val(self):
        measure = piece.Parts[self.p_id].measures[1]
        self.assertEqual("mp", measure.expressions[1][2][0].mark)
    ...
    def testMeasure2Direction1Val(self):
        measure = piece.Parts[self.p_id].measures[2]
        self.assertEqual("mf", measure.expressions[1][0][0].mark)
    ...
    def testMeasure2Direction4Val(self):
        measure = piece.Parts[self.p_id].measures[2]
        self.assertEqual("f", measure.expressions[1][1][0].mark)
    ...
    def testMeasure3Direction1Val(self):
        measure = piece.Parts[self.p_id].measures[3]
        self.assertEqual("ff", measure.expressions[1][0][0].mark)
    ...
    def testMeasure3Direction5Val(self):
        measure = piece.Parts[self.p_id].measures[3]
        self.assertEqual("fff", measure.expressions[1][2][0].mark)
