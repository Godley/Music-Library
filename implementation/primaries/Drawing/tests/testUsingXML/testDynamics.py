...
class testDynamics(xmlSet):
    ...
    def testMeasure1Direction1Val(self):
        measure = piece.Parts[self.p_id].measures[1]
        self.assertEqual("ppp", measure.items[1][0].mark)

    def testMeasure1Direction3(self):
        measure = piece.Parts[self.p_id].measures[1]
        self.assertIsInstance(measure.items[1][2], Directions.Dynamic)

    def testMeasure1Direction3Val(self):
        measure = piece.Parts[self.p_id].measures[1]
        self.assertEqual("pp", measure.items[1][2].mark)

    def testMeasure1Direction5(self):
        measure = piece.Parts[self.p_id].measures[1]
        self.assertIsInstance(measure.items[1][4], Directions.Dynamic)

    def testMeasure1Direction5Val(self):
        measure = piece.Parts[self.p_id].measures[1]
        self.assertEqual("p", measure.items[1][4].mark)

    def testMeasure1Direction7(self):
        measure = piece.Parts[self.p_id].measures[1]
        self.assertIsInstance(measure.items[1][6], Directions.Dynamic)

    def testMeasure1Direction7Val(self):
        measure = piece.Parts[self.p_id].measures[1]
        self.assertEqual("mp", measure.items[1][6].mark)
    ...
    def testMeasure2Direction1Val(self):
        measure = piece.Parts[self.p_id].measures[2]
        self.assertEqual("mf", measure.items[1][0].mark)

    def testMeasure2Direction4(self):
        measure = piece.Parts[self.p_id].measures[2]
        self.assertIsInstance(measure.items[1][3], Directions.Dynamic)

    def testMeasure2Direction4Val(self):
        measure = piece.Parts[self.p_id].measures[2]
        self.assertEqual("f", measure.items[1][3].mark)
    ...
    def testMeasure3Direction1Val(self):
        measure = piece.Parts[self.p_id].measures[3]
        self.assertEqual("ff", measure.items[1][0].mark)
    ...
    def testMeasure3Direction5Val(self):
        measure = piece.Parts[self.p_id].measures[3]
        self.assertEqual("fff", measure.items[1][4].mark)
