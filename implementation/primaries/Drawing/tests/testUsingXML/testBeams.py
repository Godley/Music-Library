...
class testArpeg(xmlSet):
    ...
    def testNote1(self):
        item = piece.Parts[self.p_id].measures[1].notes[1][0]
        self.assertFalse(hasattr(item, "beams"))

    def testNote2(self):
        item = piece.Parts[self.p_id].measures[1].notes[1][1]
    ...
    def testNote3(self):
        item = piece.Parts[self.p_id].measures[1].notes[1][2]
        self.assertTrue(hasattr(item, "beams"))
    ...
    def testNote4(self):
        item = piece.Parts[self.p_id].measures[1].notes[1][3]
        self.assertTrue(hasattr(item, "beams"))
    ...
    def testNote5(self):
        item = piece.Parts[self.p_id].measures[1].notes[1][4]
        self.assertFalse(hasattr(item, "beams"))

    def testNote6(self):
        item = piece.Parts[self.p_id].measures[1].notes[1][5]
        self.assertTrue(hasattr(item, "beams"))
    ...
    def testNote7(self):
        item = piece.Parts[self.p_id].measures[1].notes[1][6]
        self.assertTrue(hasattr(item, "beams"))
    ...
    def testNote8(self):
        item = piece.Parts[self.p_id].measures[1].notes[1][7]
        self.assertTrue(hasattr(item, "beams"))
