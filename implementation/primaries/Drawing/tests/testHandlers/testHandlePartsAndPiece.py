...
class testSetupPiece(unittest.TestCase):
    ...
    def testNoTags(self):
        self.assertEqual(None, self.handler(self.tags,self.attrs,self.chars,self.piece, self.data), "ERROR: testNoTags failed: nothing should happen if there are no tags in list")
    ...
    def testIrrelevantTag(self):
        ...
        self.assertEqual(None, self.handler(self.tags,self.attrs,self.chars,self.piece, self.data), "ERROR: irrelevant tag should do nothing in TestIrrelevance")
