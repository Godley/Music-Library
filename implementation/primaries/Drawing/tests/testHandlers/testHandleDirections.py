...
class testHandleDirections(testclass.TestClass):
    ...
    def copy(self):
        ...
        if 1 in MxmlParser.notes:
            self.measure.notes.extend(MxmlParser.notes[1])
            MxmlParser.notes = {}
        if 1 in MxmlParser.expressions:
            self.measure.expressions.update(MxmlParser.expressions[1])
            MxmlParser.expressions = {}
    ...
    def testDirectionAttribTag(self):
        ...
        self.copy()
        self.assertEqual("above", self.measure.items[0][0].placement)
    ...
    def testDirectionTag(self):
        ...
        self.assertEqual("hello, world", measure.items[0][0].text)
    ...
    def testWordsWithFontSizeAttrib(self):
        ...
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertTrue(hasattr(self.measure.items[0][0], "size"))
        self.assertEqual("6.5", self.measure.items[0][0].size)
    ...
    def testWordsWithFontFamAttrib(self):
        ...
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertTrue(hasattr(self.measure.items[0][0], "font"))
        self.assertEqual("times", self.measure.items[0][0].font)
    ...
    def testWordsWithBothAttribs(self):
        ...
        self.copy()
        self.assertEqual("times", self.measure.items[0][0].font)
        self.assertEqual("6.2", self.measure.items[0][0].size)

    def testOctaveShift(self):
        self.tags.append("octave-shift")
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertIsInstance(self.measure.items[0][0], Directions.OctaveShift)
    ...
    def testOctaveShiftType(self):
        ...
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertTrue(hasattr(self.measure.items[0][0], "type"))
    ...
    def testOctaveShiftAmount(self):
        ...
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertTrue(hasattr(self.measure.items[0][0], "amount"))
        self.assertEqual(8, self.measure.items[0][0].amount)

    def testWavyLine(self):
        self.tags.append("wavy-line")
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertIsInstance(self.measure.items[0][0], Directions.WavyLine)
    ...
    def testWavyLineType(self):
        ...
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertEqual("start", self.measure.items[0][0].type)

    def testPedal(self):
        self.tags.append("pedal")
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertIsInstance(self.measure.items[0][0], Directions.Pedal)
    ...
    def testPedalLine(self):
        ...
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertEqual(True, self.measure.items[0][0].line)
    ...
    def testBracket(self):
        ...
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertIsInstance(self.measure.items[0][0], Directions.Bracket)
    ...
    def testBracketNumber(self):
        ...
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertEqual(1, self.measure.items[0][0].number)
    ...
    def testBracketLineEnd(self):
        ...
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertEqual("none", self.measure.items[0][0].lineEnd)
    ...
    def testBracketEndLength(self):
        ...
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertEqual(15, self.measure.items[0][0].endLength)
    ...
    def testBracketLineType(self):
        ...
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertEqual("solid", self.measure.items[0][0].lineType)
...
class testMetronome(testHandleDirections):
    ...
    def testMetronomeBeatUnitTag(self):
        ...
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertTrue(hasattr(self.measure.items[0][0], "beat"))
        self.assertEqual("quarter", self.measure.items[0][0].beat)
    ...
    def testBeatUnitWithFontAttrib(self):
        ...
        self.assertTrue(hasattr(self.measure.items[0][0], "beat"))
        self.assertEqual("quarter", self.measure.items[0][0].beat)
        self.assertTrue(hasattr(self.measure.items[0][0], "parentheses"))
        self.assertEqual(True, self.measure.items[0][0].parentheses)
    ...
    def testPerMinuteTag(self):
        ...
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertEqual(1, len(self.measure.items[0]))
        self.assertTrue(hasattr(self.measure.items[0][0], "min"))
        self.assertEqual("85", self.measure.items[0][0].min)
    ...
    def testPerMinuteParenthesesAttrib(self):
        ...
        self.copy()
        self.assertTrue(hasattr(self.measure.items[0][0], "parentheses"))
        self.assertTrue(self.measure.items[0][0].parentheses)
...
class testDynamicsAndSound(testHandleDirections):
    def testDynamicTag(self):
        ...
        self.assertTrue(len(self.measure.expressions) > 0)
        self.assertEqual(Directions.Dynamic, type(self.measure.expressions[0][-1]))
        self.assertEqual("p", self.measure.expressions[0][-1].mark)
    ...
    def testWedgeTag(self):
        ...
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertIsInstance(self.measure.expressions[0][-1], Directions.Wedge)
    ...
    def testWedgeVal(self):
        ...
        self.handler(self.tags, self.attrs, self.chars, self.piece)
        self.copy()
        self.assertTrue(hasattr(self.measure.expressions[0][-1], "type"))
        self.assertEqual("crescendo", self.measure.expressions[0][-1].type)