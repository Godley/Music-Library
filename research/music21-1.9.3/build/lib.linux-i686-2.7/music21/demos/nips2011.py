...
def getWikifoniaDatesFromBillboard():    
    '''
    script to generate a json list matching wikifonia files to their dates. script compiles list of Billboard
    top 100 songs from jamrockentertainment.com, then uses this dictionary to match up titles from 
    wikifonia file. Last updated: 10/6/2011, Beth Hadley
